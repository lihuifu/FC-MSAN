...
from model.MKSTGCN import build_MKSTGCN
from model.DataGenerator import DominGenerator
from model.Utils import *

print(128 * '#')
print('Start to evaluate MKSTGCN.')
...
for i in range(fold):
    ...
    # build MKSTGCN
    model, model_p = build_MKSTGCN(cheb_k, num_of_chev_filters, num_of_time_filters, time_conv_strides, cheb_poly_DC,
    ...
    model.load_weights(Path['Save']+'MKSTGCN_Best_'+str(i)+'.h5')
...
print('End of evaluating MKSTGCN.')
print(128 * '#')
